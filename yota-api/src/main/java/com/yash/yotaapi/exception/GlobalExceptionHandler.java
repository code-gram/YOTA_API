...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Custom exception handler method to handle {@link UnitAlreadyExistsException}.
     *
     * This method catches exceptions of type {@link UnitAlreadyExistsException} and generates a custom
     * {@link ResponseEntity} with an {@link ExceptionResponse} containing the error message.
     *
     * @param e The {@link UnitAlreadyExistsException} instance to handle.
     ...
     * indicating that the unit name cannot be empty or null.
     *
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ExceptionResponse error = new ExceptionResponse("Unit name can not be empty or null");
