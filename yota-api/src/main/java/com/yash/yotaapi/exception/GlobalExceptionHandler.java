...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleApplicationException(ApplicationException applicationException) {
        ExceptionResponse message = new ExceptionResponse(applicationException.getMessage());
