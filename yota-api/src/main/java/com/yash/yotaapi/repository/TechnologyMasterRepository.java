...
public interface TechnologyMasterRepository extends JpaRepository<TechnologyMaster, Long> {
	...
	/**
	 * getByNameContaining method will be used to search ParentTechnology based on
	 ...
	 * 
	 * @return List of ParentTechnologies if status is false it will return in form
	 *         of List But if it true then it won't return that Technology
	 */
