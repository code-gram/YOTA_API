...
/**
 * AssociateDetailsRepository will perform all the CRUD Operations on
 * AssociateDetails. In case if any customization is required on CRUD
 * operations, it can be done here.
 * 
...
public interface AssociateDetailsRepository extends JpaRepository<AssociateDetails, Long> {
	...
	/**
	 * getByEmailIdContaining will give the list of associates using given keyword
	 * containing in Mail Id.
	 * 
	 * @param keyword
	 */
	...
	/**
	 *  * We can fetch associate using findById method.  * @param id  
	 */
