...
/**
 * This Test Management model will work as a data transfer object. Field
...
public class Test {
	...
	/**
	 * Id of test for unique identification.This is going to be Primary Key.
	 */
	@Id
	...
	/** persist action to set the created date. */
	@PrePersist
	public void onCreate() {
		this.createdAt = new Date();
	}

	/** update action to set the updated date. */
	@PreUpdate
